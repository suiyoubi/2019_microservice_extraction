...
PROJECT_PACKAGE=org.javaee7.wildfly.samples.everest
WORKFLOW=${OUTPUT}/${PROJECT_NAME}_workflow
python traceWorkflow.py ./kieker_logs/${PROJECT_NAME} ${WORKFLOW}.csv ${PROJECT_PACKAGE}
